...
import { addDoctorData, deleteDoctorData, getDoctorData, updateDoctorData } from '../../../redux/action/adminDoctors.action'
        ...
        <div>

            {
                doctorData.isloading ? <CircularProgress color="secondary" /> :
                    ...
                    <>
                        <AdminDoctorForm onhandlesubmit={handlesubmit} onupdate={update} />
